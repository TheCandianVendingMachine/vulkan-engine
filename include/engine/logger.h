...
template<> class fmt::formatter<ENGINE_NS::logger::Entry> {
public:
...
template<> class fmt::formatter<const ENGINE_NS::logger::Entry&>: fmt::formatter<ENGINE_NS::logger::Entry> {
public:
    auto format(const ENGINE_NS::logger::Entry& entry, fmt::format_context& ctx) const->fmt::format_context::iterator;
};

template<> class fmt::formatter<ENGINE_NS::logger::Entry&>: fmt::formatter<ENGINE_NS::logger::Entry> {
public:
    auto format(ENGINE_NS::logger::Entry& entry, fmt::format_context& ctx) const->fmt::format_context::iterator;
};
