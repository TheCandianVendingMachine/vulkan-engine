...
struct Matrix2LU {
        ...
        auto lower() -> Matrix2<T> {
            return Matrix2<T>(combined.r1c1, T(0), combined.r2c1, combined.r2c2);
        }
        auto lower_unit() -> Matrix2<T> {
            return Matrix2<T>(T(1), T(0), combined.r2c1, T(1));
        }
        auto upper() -> Matrix2<T> {
            return Matrix2<T>(combined.r1c1, combined.r1c2, T(0), combined.r2c2);
        }
        auto upper_unit() -> Matrix2<T> {
            return Matrix2<T>(T(1), combined.r1c2, T(0), T(1));
        }
};
...
struct Matrix3LU {
        ...
        auto lower() -> Matrix3<T> {
            return Matrix3<T>(combined.r1c1, T(0), T(0), combined.r2c1, combined.r2c2, T(0), combined.r3c1, combined.r3c2, combined.r3c3);
        }
        ...
        auto upper() -> Matrix3<T> {
            return Matrix3<T>(combined.r1c1, combined.r1c2, combined.r1c3, T(0), combined.r2c2, combined.r2c3, T(0), T(0), combined.r3c3);
        }
        auto upper_unit() -> Matrix3<T> {
            return Matrix3<T>(T(1), combined.r1c2, combined.r1c3, T(0), T(1), combined.r2c3, T(0), T(0), T(1));
        }
};
...
struct Matrix4LU {
        ...
        auto upper_unit() -> Matrix4<T> {
            return Matrix4<T>(T(1), combined.r1c2, combined.r1c3, combined.r1c4, T(0), T(1), combined.r2c3, combined.r2c4, T(0), T(0), T(1),
                              combined.r3c4, T(0), T(0), T(0), T(1));
        }
        auto upper() -> Matrix4<T> {
            return Matrix4<T>(combined.r1c1, combined.r1c2, combined.r1c3, combined.r1c4, T(0), combined.r2c2, combined.r2c3, combined.r2c4,
                              T(0), T(0), combined.r3c3, combined.r3c4, T(0), T(0), T(0), combined.r4c4);
        }
};
} // namespace linalg
