...
extern "C"
{
    ...
    */
    float* smvprod2(float* out, float* A, const float* x) {
        std::memcpy(out,
    ...
    float* ssolve2l(float* out, float* L, float* b) {
        std::memcpy(out,
    ...
    float* ssolve2u(float* out, float* U, float* b) {
        std::memcpy(out,
    ...
    float* ssolve2(float* out, float* A, float* b) {
        std::memcpy(
            out,
    ...
    double* dmvprod2(double* out, double* A, const double* x) {
        std::memcpy(out,
    ...
    double* dsolve2l(double* out, double* L, double* b) {
        std::memcpy(out,
    ...
    double* dsolve2u(double* out, double* U, double* b) {
        std::memcpy(out,
    ...
    double* dsolve2(double* out, double* A, double* b) {
        std::memcpy(
            out,
    ...
    */
    float* smvprod3(float* out, float* A, const float* x) {
        std::memcpy(out,
    ...
    float* ssolve3l(float* out, float* L, float* b) {
        std::memcpy(out,
    ...
    float* ssolve3u(float* out, float* U, float* b) {
        std::memcpy(out,
    ...
    float* ssolve3(float* out, float* A, float* b) {
        std::memcpy(
            out,
    ...
    double* dmvprod3(double* out, double* A, const double* x) {
        std::memcpy(out,
    ...
    double* dsolve3l(double* out, double* L, double* b) {
        std::memcpy(out,
    ...
    double* dsolve3u(double* out, double* U, double* b) {
        std::memcpy(out,
    ...
    double* dsolve3(double* out, double* A, double* b) {
        std::memcpy(
            out,
    ...
    */
    float* smvprod4(float* out, float* A, const float* x) {
        std::memcpy(out,
    ...
    float* ssolve4l(float* out, float* L, float* b) {
        std::memcpy(out,
    ...
    float* ssolve4u(float* out, float* U, float* b) {
        std::memcpy(out,
    ...
    float* ssolve4(float* out, float* A, float* b) {
        std::memcpy(
            out,
    ...
    double* dmvprod4(double* out, double* A, const double* x) {
        std::memcpy(out,
    ...
    double* dsolve4l(double* out, double* L, double* b) {
        std::memcpy(out,
    ...
    double* dsolve4u(double* out, double* U, double* b) {
        std::memcpy(out,
    ...
    double* dsolve4(double* out, double* A, double* b) {
        std::memcpy(
            out,
