...
namespace linalg {
    namespace blas1 {
        ...
        auto dot(const Vector4<float> a, const Vector4<float> b) -> float {
            ...
            auto v_bal = _mm_shuffle_ps(v_abl, v_abl, 0b00'01'00'01);
            auto v_dotl = _mm_add_ps(v_abl, v_bal);

            auto v_bah = _mm_shuffle_ps(v_abh, v_abh, 0b00'01'00'01);
...
namespace linalg {
    namespace blas1 {
        ...
        auto dot(const Vector4<double> a, const Vector4<double> b) -> double {
            ...
            auto v_bal = _mm_shuffle_pd(v_abl, v_abl, 0b00'01'00'01);
            auto v_dotl = _mm_add_pd(v_abl, v_bal);

            auto v_abh = _mm_mul_pd(v_ah, v_bh);
            auto v_bah = _mm_shuffle_pd(v_abh, v_abh, 0b00'01'00'01);
