...
namespace test_matrix {
    ...
    TEST_CASE("Matrix4LU::from [Matrix4<float>]", "[Matrix4]") {
        SECTION("Single") {
            linalg::Matrix4<float> A(2.f, -1.f, -2.f, 9.f, -4.f, 6.f, 3.f, -5.f, -4.f, -2.f, 8.f, 0.f, 2.f, 1.f, 1.f, -1.f);
    ...
    TEST_CASE("blas2::solve_lower_triangular [Matrix4<float>]", "[blas2][Matrix4]") {
        SECTION("Single") {
            linalg::Matrix4<float> A(2.f, 0.f, 0.f, 0.f, -4.f, 6.f, 0.f, 0.f, -4.f, -2.f, 8.f, 0.f, 2.f, 1.f, 1.f, -1.f);
            linalg::Vector4<float> b(11.f, 6.f, -3.f, 1.f);
    ...
    TEST_CASE("blas2::solve_upper_triangular [Matrix4<float>]", "[blas2][Matrix4]") {
        SECTION("Single") {
            linalg::Matrix4<float> A(2.f, -1.f, -2.f, 9.f, 0.f, 6.f, 3.f, -5.f, 0.f, 0.f, 8.f, 0.f, 0.f, 0.f, 0.f, -1.f);
            linalg::Vector4<float> b(11.f, 6.f, -3.f, 1.f);
